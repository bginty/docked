...
- Shopify CLI: 4.5.2
- Source validation: Theme Check 186/0; structural validation 57/57; Node tests 5/5; copy and data audits passed; production gate validator 21/21 required gates and 23 total gates; dependency audit 0 vulnerabilities; documentation links 48 files/172 references/0 broken (excluding two intentional upstream PR-template placeholders); secret scan 0 high-confidence matches
- Shopify upload evidence: existing live `Horizon` theme ID `130871099450` preserved; exact commit `0b8d127b83d68930992643d666a7d26c1f1b067d` strictly pushed from 10:43:36 to 10:44:47 AEST to unpublished `Docked Production Candidate 2026-08`, theme ID `130871427130`, with returned store/role/name and permanent preview/editor URLs recorded
- Admin settings evidence: AUD, Australia/Melbourne, metric and kilograms verified; supplied business address and `support@docked.com.au` configured. After the owner's mailbox-setup report, Notifications still showed the sender as **Unverified** with **Resend verification** available. Australia is the only active market; new customer accounts are active.
...
- Rendered evidence: partial manual in-app-browser QA completed at 320, 360, 375, 390, 768, 1024 and 1440 px. A 320 px overflow defect was fixed and re-tested. After the exact-commit push, the candidate measured `innerWidth=390` and `scrollWidth=390`; its mobile menu showed the exact updated six links. Explore rendered the exact seven planned collection links, Help and policies rendered the seven support links, and Shopify's native Privacy policy link rendered separately through `show_policy`; the unused `footer-legal-menu` resource did not render. Safety and Care and FAQ render with one H1 and no 404, the eight-item FAQ accordion was exercised, and Shopify accepted a controlled Contact submission. The signed-out account button opened Shopify's new account dialog, but no credentials were entered and authentication/logout/history remain untested. The automated storefront command was attempted but stopped before assertions because Playwright is not installed. Mailbox delivery, full multi-browser, accessibility, Lighthouse, product and checkout testing remains incomplete.
...
| Theme preview uploaded | Passed | Clean strict full push of unpublished `Docked Production Candidate 2026-08`, ID `130871427130`, with permanent preview/editor URLs and existing live theme preserved |
