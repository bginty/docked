...
- Shopify upload evidence: existing live `Horizon` theme ID `130871099450` preserved; `Docked Production Candidate 2026-08` theme ID `130871427130` uploaded cleanly as unpublished, with permanent preview and editor URLs recorded
- Admin settings evidence: AUD, Australia/Melbourne, metric and kilograms verified; supplied business address and `support@docked.com.au` configured. Shopify reports the sender email as unverified and a verification email was sent. Australia is the only active market; new customer accounts are active.
...
- Rendered evidence: partial manual in-app-browser QA completed at 320, 360, 375, 390, 768, 1024 and 1440 px. A 320 px overflow defect was fixed and re-tested; the updated Main menu rendered on desktop, while its six-link contents were not reverified in the mobile menu. Safety and Care and FAQ render with one H1 and no 404, the eight-item FAQ accordion was exercised, and Shopify accepted a controlled Contact submission. The signed-out account button opened Shopify's new account dialog, but no credentials were entered and authentication/logout/history remain untested. The automated storefront command was attempted but stopped before assertions because Playwright is not installed. The locally prepared named-footer mapping is not yet evidenced as re-pushed/rendered. Mailbox delivery, full multi-browser, accessibility, Lighthouse, product and checkout testing remains incomplete.
