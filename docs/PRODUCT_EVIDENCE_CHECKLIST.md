...
Evidence is acceptable only when it:

- identifies the supplier, manufacturer, exact model, production revision and SKU;
- applies to the final product, components, packaging and instructions that Docked will actually supply;
- is complete, legible, dated and attributable to its issuer;
- includes a laboratory name, report number, tested sample identification, methods, results and authorised signatory where testing is relied on;
- can be reconciled to the product label, manual, packaging, Shopify data and customer-facing claims;
- has been checked for scope, expiry, retest or surveillance requirements; and
- is stored in an access-controlled evidence repository, with only a safe reference committed to Git.

A supplier statement such as “adult product”, a CE/FCC mark, a marketplace listing, a sample photo or a certificate for a similar model is not sufficient by itself. Redact banking details, credentials, personal data and commercially sensitive material before placing anything in the repository.

## Core supplier and SKU dossier

Complete these items for every supplier and every final SKU.

| Evidence item | Minimum acceptable content | Current state |
| --- | --- | --- |
| Supplier legal identity | Registered legal name, registration number, address and authorised contact | Not received |
...
## Aquatic-product overlay

Apply this section to all powered floats, adult loungers, islands, pool games, floating coolers and drink holders.

| Evidence or decision | Required result | Current state |
| --- | --- | --- |
| Written Australian classification review | Exact-SKU assessment of design, size, capacity, foreseeable use, supplier marketing, packaging, instructions, imagery and age grading | Not started |
| Aquatic-toy assessment | Written applicable/not-applicable decision; if applicable, all current mandatory-standard requirements and reports | Not started |
| Swimming/flotation-aid and PFD assessment | Written decision confirming whether any such regime applies; marketing name is not determinative | Not started |
| Adult audience | Final packaging, instructions and imagery aligned to adults 18+ without hiding or altering required warnings | Not received |
| Approved environment | Verified permitted water environment and pool-size/depth constraints | Not received |
| Occupancy and load | Verified occupancy and maximum user/load limits | Not received |
| Construction and valves | Final drawings/specification and applicable valve, seam, chamber and attachment evidence | Not received |
| Permanent warnings | Exact required wording, placement, visibility, permanence and durability evidence | Not received |
| Boarding and exit | Model-specific safe entry, boarding, exit and recovery instructions | Not received |
| Inspection and maintenance | Pre-use checks, damage criteria, cleaning, drying, storage and end-of-life instructions | Not received |
| Marketing reconciliation | Signed comparison of final label/manual statements against all website specifications and claims | Not started |

Adult-only positioning is a merchandising rule, not evidence that an aquatic-toy, swimming/flotation-aid or other safety regime is inapplicable.

## Powered, electrical, battery and radio overlay

Apply the relevant line to each powered float and to the rechargeable air pump. Apply radio requirements if any controller contains a transmitter or receiver.
...
| Electrical classification | Written Australian electrical-safety/EESS determination for each product and charger | Not started |
...
| Radio/EMC evidence | Applicable test reports, supplier declaration/records, registration and lawful RCM basis | Not received |

## Category-specific overlays

### Canopy products

- Canopy attachment, release/folding and wind-use instructions.
- Evidence supporting any sun-protection claim; otherwise no quantified or complete-protection claim.
- Confirmation that the canopy is not presented as a grab handle.

### Pool games, floating coolers and drink holders

- Final pool-size, water-depth, capacity and anchoring requirements.
- Net, cord and anchor entanglement assessment for games.
- Verified load/capacity and stability evidence for coolers and trays.
- Packaging and imagery that exclude glass and do not promote intoxication around a pool.

### Pumps, repair products and storage pouch

- Pump ratings, instructions, overinflation controls and product compatibility.
- For the rechargeable pump: battery, electrical, charging and transport evidence above.
- Repair-kit ingredient/material declaration, safety data where applicable, application limits, warnings and compatibility evidence.
- Storage-pouch test report, test method, rating, closure/use instructions and exclusions before any waterproof or water-resistant claim.

## Content, commercial and operational evidence

| Gate | Required input | Current state |
| --- | --- | --- |
| Product photography | Final product shown accurately; adult models only for aquatic products; written usage licence | Blocked |
| Demonstration media | Safe behaviour, approved environment and exact final model; written licence | Blocked |
| Product copy | Claims traceable to accepted evidence; approved warnings displayed prominently | Blocked |
| Final price | Current market research, landed cost model and owner approval | Blocked |
| Shipping | Packed weight/dimensions, service acceptance, rates and battery restrictions | Blocked |
| Inventory | Final SKU/variant mapping and counted stock | Blocked |
...
For each accepted item, record the evidence filename or controlled repository reference, issuer, issue date, report/certificate number, exact model/SKU, reviewer, review date and expiry/retest date in `docs/COMPLIANCE_REGISTER.md`. Missing, ambiguous, model-mismatched or expired evidence keeps the product Draft.
