...
One-product commit `bb41a70d630041e95f627d05c62b7247b04257f7` is committed and strictly pushed to unpublished candidate theme `130871427130`. Limited evidence confirms password protection, current one-product password-page copy and the Theme Editor's one-product homepage composition; full inner homepage, product and commerce/browser QA remains unrun. Existing detailed preview QA for `5f46487d1f53e45f5706ae945eeb5a09064893e3` is historical and does not pass the current candidate. Supplier component-level evidence receipt does not change the rollback posture and passes no launch gate.
